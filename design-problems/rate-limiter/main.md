...
| 5.         | How to implement in a distributed system?                 | - Use Redis / Memcached to store token counts. <br/>- Use atomic operations (e.g., [Redis Lua scripts](../../Readme.md#Redis-Lua-Scripts)) to avoid race conditions                                                                                                                                                                   |
